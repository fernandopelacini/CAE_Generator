Module Constantes
    Public Const MENSAJE_ERROR As String = "Se ha producido un error. Contacte con soporte"
    ...
    Public Const TRAER_CERTIFICADO_PARAMETROS As String = "traerCertificadosParametros"
    Public Const TABLA_CERTIFICADO_PARAMETROS As String = "tblCertificadosParametros"
    ...
    Public Const INSERTAR_CAEA As String = "insertarCAEA"
